...
namespace FourDO.Emulation.Plugins.Input.JohnnyInput
{
	public partial class JohnnyInputSettings
	{
		private void Localize()
		{
			...
			this.MainTabControl.TabPages[4].Text = JohnnyInputStrings.Player + " 4";
			this.MainTabControl.TabPages[5].Text = JohnnyInputStrings.Player + " 5";
			this.MainTabControl.TabPages[6].Text = JohnnyInputStrings.Player + " 6";
